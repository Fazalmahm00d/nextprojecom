...
function FeaturedProducts(){
    ...
    return(
        <div className="py-10 px-20 flex flex-col items-center">
            ...
            <div className="grid grid-cols-4 gap-10 w-full mt-6">
                {
                    featuredproducts.map((items)=>{
                        ...
                        return <Link href={`products/${productId}`}><div className="group relative cursor-pointer h-[28rem]">
                                    <div className="h-[70%]">
            ...
            <div className="mt-10"><Link href='/shop'><button className="font-bold border-2 border-[#B88E2F] text-[#B88E2F] px-20 py-4 hover:bg-[#B88E2F] hover:text-white">Show More</button></Link></div>
        </div>
    )
}
