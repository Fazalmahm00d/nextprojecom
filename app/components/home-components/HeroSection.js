...
function HeroSection(){
    ...
    return(
        <div className="relative">
            ...
            <div className="container max-w-7xl mx-auto absolute top-0 flex justify-center items-center h-full w-full sm:bottom-[-10px] sm:right-[20px] lg:top-[70px] lg:right-[100px] sm:justify-end sm:items-center lg:py-[250px] sm:h-[85vh] sm:px-8 lg:px-20">
                <div className="w-2/3 sm:w-1/2 lg:p-10 sm:w-2/5 rounded-lg p-4 bg-[#FFF3E3] ">
                    ...
                    <p className="lg:text-lg sm:text-md font-medium pb-6 lg:pb-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
