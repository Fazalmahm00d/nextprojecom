    ...
    return(
        <div className="py-20">
            <div className="flex flex-col items-center ">
                ...
                <div className=" text-center text-xl w-1/2 text-[#9F9F9F]">For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</div>
            </div>
            <div className="flex px-40 py-10 mt-10">
                <div className="w-1/2 flex flex-col gap-6">
                    <ContactSub svg={<svg width="22" height="28" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ContactSub svg={<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ContactSub svg={<svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-1/2">
                    <form className="flex flex-col gap-8 text-[#9F9F9F]">
                        ...
                        <input  placeholder="Abc" className="w-full p-4 rounded-xl border-gray-500 border-2"/>
                        <label className="font-bold text-black">Email address</label>
                        <input placeholder="Abc@def.com" className="w-full p-4 rounded-xl border-gray-500 border-2"/>
                        <label className="font-bold text-black">Subject</label>
                        <input placeholder="This is an optional" className="w-full p-4 rounded-xl border-gray-500 border-2"/>
