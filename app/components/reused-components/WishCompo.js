...
function WishCompo(props){
    ...
    return(
        ...
        {
                deleteWishItemMutation.isPending ? 
                <button className="animate-spin h-4 w-4 border-t-transparent border-gray-800 rounded-full border-2"></button> 
                :
                <button onClick={()=>deleteWishItemHandler(props.item._id)}>
